...
function endgame() {
  if (playerScore === 5) {
    computerScore = 0;
    playerScore = 0;
    return (resultsDiv.innerHTML = "You beat the computer! -- <strong>Select again to restart.</strong>");
  } else {
    computerScore = 0;
    playerScore = 0;
    return resultsDiv.innerHTML = "Computer beat ya. -- <strong>Select again to restart.</strong>";
  }
}
